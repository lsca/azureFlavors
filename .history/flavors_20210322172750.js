...
const flavorItems = [];
const pages = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000];
...
const parentHttpOptions = {

    uri: `http://prices.azure.com/api/retail/prices?$filter=serviceName%20eq%20%27Virtual%20Machines%27&$skip=100`,
    method: "POST",
    headers: {
        "Content-Type": "application/json"
    },
