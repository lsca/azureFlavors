...
const httpsOptions = createHttpOptions({publicIp: 'https://prices.azure.com', port: '443'}, '/api/retail/prices?$filter=serviceName%20eq%20%27Virtual%20Machines%27', 'GET');
